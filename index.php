...
<html class="loading">
  <head>
    ...
    <title>GhostKiller Checker CC</title>
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>GhostKiller Checker CC</strong></h4>

					<textarea rows="12" class="form-control text-center form-checker mb-2" placeholder="PUT  YOUR CARDS HERE"></textarea>
					
			<textarea rows="1" class="form-control text-center" id="sec" placeholder="Telegram ID"></textarea></br>
					
					
					          <select name="gate" id="gate" class="form-control" style="margin-bottom: 5px;"
    <option </option>
    
    <option style="background:rgba(165, 154, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usd1.php">1$</option>
    
<option style="background:rgba(165, 154, 154, 0.281);color:rgb(255, 208, 0);color:white"  value="gate/usd0.5.php">$0.5</option>
...
<h5>APPROVED :<span class="badge badge-success float-right charge">26</span></h5><hr>

<h5>CVV :<span class="badge badge-success float-right cvvs">4</span></h5><hr>

<h5>CCN :<span class="badge badge-success float-right aprovadas">1</span></h5><hr>
